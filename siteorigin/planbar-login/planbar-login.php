...
class SiteoriginWlsPlanbarLogin_Widget extends SiteOrigin_Widget
{
	public function __construct()
	{
		parent::__construct(
			...
			[
				'description' => __('Planbar Login', '5anker'),
			],
			[
			],
			false,
...
siteorigin_widget_register('wls-planbar-login', __FILE__, 'SiteoriginWlsPlanbarLogin_Widget');
