...
class Anker_Connect_Elementor_Wls_SearchDay_Widget extends \Elementor\Widget_Base
{
	...
	protected function render($instance = [])
	{
		...
		<wls-search-day<?php echo !empty($settings['query']) ? (' query="' . esc_attr($settings['query']) . '"') : ''; ?><?php echo !empty($settings['fields']) ? (' fields="' . esc_attr($settings['fields']) . '"') : ''; ?>></wls-search-day>
		<?php
	}
}
