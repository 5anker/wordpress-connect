...
class Anker_Connect_Elementor_Wls_SearchWaterCamper_Widget extends \Elementor\Widget_Base
{
	...
	protected function render($instance = [])
	{
		...
		<wls-search-watercamper<?php echo !empty($settings['query']) ? (' query="' . esc_attr($settings['query']) . '"') : ''; ?><?php echo !empty($settings['fields']) ? (' fields="' . esc_attr($settings['fields']) . '"') : ''; ?>></wls-search-watercamper>
		<?php
	}
}
