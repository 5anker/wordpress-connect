(function(wp) {
	 ...
	 */
	registerBlockType('anker-connect/wls-search-watercamper', {
		/**
		 * This is the display title for your block, which can be translated with `i18n` functions.
		 * The block inserter will show this name.
		 */
		title: __('Search WaterCamper', '5-anker-connect'),
				...
				el(
					...
					el(
						TextControl, {
							...
							placeholder: __('Fields', '5-anker-connect'),
							onChange: function(v) {
		...
		save: function(props) {
			return el('wls-search-watercamper', {
